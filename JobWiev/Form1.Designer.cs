namespace JobWiev
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.JobViewIcon = new System.Windows.Forms.NotifyIcon(this.components);
			...
			this.MoneyHour.TextChanged += new System.EventHandler(this.MoneyHour_TextChanged);
			// 
			// label3
			// 
			...
			// JobViewIcon
			// 
			this.JobViewIcon.Icon = ((System.Drawing.Icon)(resources.GetObject("JobViewIcon.Icon")));
			this.JobViewIcon.Text = "JobView";
			this.JobViewIcon.Visible = true;
			// 
			// Form1
			// 
        ...
        private System.Windows.Forms.NotifyIcon JobViewIcon;
    }
}
